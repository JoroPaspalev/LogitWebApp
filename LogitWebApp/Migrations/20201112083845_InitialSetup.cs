...
namespace LogitWebApp.Migrations
{
    public partial class InitialSetup : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Shipments_Participants_ReceiverId",
                        column: x => x.ReceiverId,
                        principalTable: "Participants",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Shipments_Participants_SenderId",
                        column: x => x.SenderId,
                        principalTable: "Participants",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Shipments_LoadingAddressId",
                table: "Shipments",
                column: "LoadingAddressId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Shipments_UnloadingAddressId",
                table: "Shipments",
